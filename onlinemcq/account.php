...
if(@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
  ...
  if ($qid) {
    ...
    if ($sn > 1) {
      if ($sn > 1) {
        echo '<button type="button" class="btn btn-primary" onclick="location.href=\'?q=quiz&step=2&eid='.$eid.'&n='.($sn-1).'&t='.$total.'\'"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Previous</button> ';
      }
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="row">
    <div class="col-md-4">
    <img src="/image/3.jpg" width="100" height="100" alt="Prakash" class="img-rounded">
     </div>
     <div class="col-md-5">
    <a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Instagram">Prakash</a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 1234567890</h4>
    <h4 style="font-family:'typo' ">pandeprakash786@gmail.com</h4>
